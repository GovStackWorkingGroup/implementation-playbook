...
You begin by creating a clear inventory of existing services. This will help you understand the current landscape, identify gaps and discover areas where digitalization can add the most value.
{% endstep %}

{% step %}
### Prioritise services&#x20;

In this step, you proritise which services must be developed. The service will be selected based on a transparent rationale, considering metrics such as user value, feasibility, impact, and alignment with national or organizational priorities.
{% endstep %}
