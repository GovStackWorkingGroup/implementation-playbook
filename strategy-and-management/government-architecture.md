...
<figure><img src="../.gitbook/assets/21.-GERA---Government-Enterprise-Reference-Architecture.jpg" alt="Government Ecosystem Reference Architecture (GERA)"><figcaption><p>Government Ecosystem Reference Architecture (GERA)</p></figcaption></figure>
...
* Define the approach to adding new/updated Building Blocks within the national stack, either through tendering, developing indigenously, or re-using existing Building Blocks. [GovMarket ](https://www.govstack.global/our-offerings/govmarket/)provides a catalog of digital public goods that can be used as a reference.
