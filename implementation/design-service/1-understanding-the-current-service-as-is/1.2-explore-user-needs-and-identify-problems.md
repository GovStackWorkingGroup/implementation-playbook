...
Review what you have learned and identify common patterns, challenges, and differences between user groups.

**4a. Bring research together**

Gather notes, quotes, observations, and findings from earlier activities including desk research, journey mapping and user interviews.

**4b. Group related findings into themes**

Cluster similar pain points, needs, or behaviours to identify patterns and themes. For each cluster, agree what it reveals about users or the service.<br>

<figure><img src="../../../.gitbook/assets/Analyse.png" alt=""><figcaption></figcaption></figure>

**4c. Draft problem statements**

Reframe the most important insights into clear problem statements. These can be very high level or specific. For example: _“How might we help \[user] to \[achieve something], given \[constraint or context]?”_

<figure><img src="../../../.gitbook/assets/analyse-findings.png" alt=""><figcaption></figcaption></figure>

**4d. Prioritise focus**

Agree which problem statements should guide the next stage of design work and why.
