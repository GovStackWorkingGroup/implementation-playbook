# 5-B.5 Create Developer Guidelines
...
* adherence to [#modular-design](5-b.2-create-container-diagram.md#modular-design "mention")and [#design-principles](5-b.3-create-component-diagram.md#design-principles "mention")
* Recommended patterns, like
  * [architecture-best-practices-and-patterns.md](architecture-best-practices-and-patterns.md "mention")
  * [GovStack Architecture Requirements](https://specs.govstack.global/architecture/6-cross-functional-requirements)
* Validation rules
