# 5-B.1 - Create Data Model & REST API
...
1. Analyze the user journeys & data flows and identify the entities and endpoints needed in each step. You can use the [GovStack Service Blueprint](https://www.figma.com/board/DAK1g4cpOaBYIEh86jrSaf/Service-Blueprint-Template?node-id=0-1\&p=f) for this.
   ...
   2. Watch out for interactions with external systems, especially those that might not yet have been identified. (In this case, also update the [5-start-with-the-system-context.md](5-start-with-the-system-context.md "mention").)
...
* and help in later steps such as [5-b.2-create-container-diagram.md](5-b.2-create-container-diagram.md "mention") and [5-b.3-create-component-diagram.md](5-b.3-create-component-diagram.md "mention").

### Document the Internal API

Defining the api in a "API First" manner will help in later steps such as [5-b.2-create-container-diagram.md](5-b.2-create-container-diagram.md "mention") and [5-b.3-create-component-diagram.md](5-b.3-create-component-diagram.md "mention"), already providing a significant part of the functionality & structure. While documenting the api, you should
