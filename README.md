...
3. Designing: Define the To-Be state of a specific digital transformation project
4. Testing: Test and improve the To-Be state with end users
5. Procuring: Procure the needed time and material for implementing the To-Be state
6. Developing: Iteratively develop the IT solution to reach the To-Be state
7. Operating: Operate the IT solution
