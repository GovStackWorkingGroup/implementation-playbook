...
Use our [Journey Mapping Template](https://www.figma.com/file/w9oqWWuuxWtab5EPJIVhhA/Journey-Template?type=whiteboard\&node-id=502-3589\&t=2jbkrrXKAmGpPeg6-0) to create As-Is and To-Be journey. It is an important base for our next steps such as service blueprint and wireframing. As-Is journey will allow you to understand current state, pain points of the user, opportunities and legal background within the flow while to-be journey will allow you to ideate and plan the future state based on the different personas.

Please do not hesitate to change, remove or add new segment and perspectives depending on your use case and scope

{% @figma/embed fileId="w9oqWWuuxWtab5EPJIVhhA" nodeId="502:3589" url="https://www.figma.com/file/w9oqWWuuxWtab5EPJIVhhA/Journey-Template?node-id=502-3589&t=2jbkrrXKAmGpPeg6-0&type=whiteboard" %}
