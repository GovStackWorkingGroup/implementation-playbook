...
* Create a preliminary version of the service using [wireframes and/or voice command flow](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow). A good wireframe and/or voice command flow requires:
  * Using [UX/UI guidelines](https://govstack.gitbook.io/specification/v/govstack-specification-main/govstack-ui-ux-guidelines) build preliminary Lo-Fi [wireframes and/or voice command flow ](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow)that show structure, placement, and hierarchy for your service. &#x20;
  ...
  * Reviewing [wireframes and/or voice command flows](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow) according to the specific 'To-be' user journey to ensure users accomplish their goals and their needs are met.&#x20;
  * Using the [wireframes and/or voice command flow](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow) to get the team’s feedback on feasibility and structure.&#x20;
  * Using [wireframes and/or voice command flow](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow) as a way of safely trying out more radical ideas.   &#x20;
...
* Give the [wireframes and/or voice command flow ](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow)to the user (Citizen/public servant/business) and public official user to observe their interactions without instruction. Ask users to perform a specific task.&#x20;
...
* [Wireframes and/or voice command flow](../../strategy-and-management/capacity-building-strategy/artefacts.md#wireframes-and-or-voice-command-flow) &#x20;
* Apply the country's [digital service design standards](../../introduction-to-govstack/3-terminology.md#digital-service-design-standard). These include standards for:
  ...
  * [Web forms](../../introduction-to-govstack/3-terminology.md#web-forms)
  * [Electronic documents](../../introduction-to-govstack/3-terminology.md#electronic-documents)
  * [Notifications](../../introduction-to-govstack/3-terminology.md#notifications)
  * [Performance analytics](../../introduction-to-govstack/3-terminology.md#performance-analytics)
  * [Citizen satisfaction survey](../../introduction-to-govstack/3-terminology.md#citizen-satisfaction-survey)
  * [Accessibility ](../../introduction-to-govstack/3-terminology.md#accessibility)
{% endtab %}
{% endtabs %}
